<div class="cu_api_keys_edit">
    ...
    <a class="tool_button tooltip btn_generate" title="<?php echo $language->update_key ?>" onclick="cu_api_keys_edit.generate()" ><span style="color: #DDD;">f</span></a>
</div>