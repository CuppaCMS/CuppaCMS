<table>
   <tr>
        ...
        <td><input style="width: 100%;" type="text" class="required" title=" " name="allowed_extensions" value="<?php echo $cuppa->configuration->allowed_extensions ?>" /></td>
    </tr>
    <tr>
        <td><span class="asterisk">*</span><?php echo @$language->upload_default_path ?></td>
        <td><input type="text" class="required" title=" " name="upload_default_path" value="<?php echo $cuppa->configuration->upload_default_path ?>" /></td>
    </tr>
    <tr>
        <td>
        ...
        <td><input type="text" class="required" title=" " name="maximum_file_size" value="<?php echo $cuppa->configuration->maximum_file_size ?>" /></td>
    </tr>
    <tr>
        <td>
        ...
        <td><input type="text" class="required" title=" " name="csv_column_separator" value="<?php echo $cuppa->configuration->csv_column_separator ?>" /></td>
    </tr> 
    <tr>
        <td>
            Tinify Key
        ...
        <td><input type="text" title=" " name="tinify_key" value="<?php echo @$cuppa->configuration->tinify_key ?>" /></td>
    </tr>             
</table>