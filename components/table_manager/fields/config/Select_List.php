...
<script type="text/javascript">
        ...
        function GetInfo(value){
            ...
            // add Data
        		if(value == "config_table"){
                    ...
                    info.data.nested_column = cuppa.trim(jQuery("#select_nested_column").val());
                    info.data.parent_column = cuppa.trim(jQuery("#select_parent_column").val());
                    info.data.init_id = cuppa.trim(jQuery("#init_id").val());
            ...
            // Extra params
                info.extraParams = {}
                info.extraParams.multiSelect = (jQuery(".multiSelect").attr("checked")) ? 1 : 0;
                info.extraParams.mirrorList = (jQuery(".mirrorList").attr("checked")) ? 1 : 0;
                info.extraParams.listHeight = jQuery(".listHeight").val();
	...
	// Set Default Info
    	function SetDefault(){
            ...
            // Extra Params
                if(obj.extraParams.multiSelect == "1") jQuery(".multiSelect").attr("checked", "checked");
                if(obj.extraParams.mirrorList == "1") jQuery(".mirrorList").attr("checked", "checked");
                jQuery(".listHeight").val(obj.extraParams.listHeight);
...
<!-- Extra Params -->
    ...
    <div style="padding-left: 20px;">
         <table class="panel_extra_params" >
            <tr>
                <td style="width:70px;"><?php echo @$language->multiselect ?>:</td>
                <td>
                    <input type="checkbox" class="multiSelect" id="multiSelect" name="multiSelect" />
                </td>
            </tr>
            <tr>
                <td style="width:70px;"><?php echo @$language->mirror_list ?>:</td>
                <td>
                    <input type="checkbox" class="mirrorList" id="mirrorList" name="mirrorList" />
                </td>
            </tr>
            <tr>
                <td style="width:70px;"><?php echo @$language->height ?>:</td>
                <td>
                    <input type="text" id="listHeight" class="listHeight" name="listHeight" value="1" />
                </td>
            </tr>
            <tr>
