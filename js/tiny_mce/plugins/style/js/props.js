...
function setupFormData() {
    ...
    //f.background_image.value = ce.style.backgroundImage
    f.box_max_width.value = ce.style.maxWidth;
    f.box_max_height.value = ce.style.maxHeight;
	// Setup border fields
...
function applyAction() {
    ...
    if(newStyles["background-image"]){
        newStyles["background-image"] = newStyles["background-image"].split("media/");
        newStyles["background-image"] = "url('media/" + newStyles["background-image"][1];
    }    
...
function generateCSS() {
    ...
    ce.style.maxWidth = f.box_max_width.value;
    ce.style.maxHeight = f.box_max_height.value;
