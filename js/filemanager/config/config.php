...
$MaxSizeUpload = $cuppa->configuration->maximum_file_size/1048576;
...
$ext_cuppa = str_replace(array("*."," "),array("",""),$cuppa->configuration->allowed_extensions);
$ext_cuppa = explode(";", $ext_cuppa);
$ext= $ext_cuppa;
